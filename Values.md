...
bookish-octo-waddle is an open source project, in the full senses of the word: we are open to ideas, we are open to contributions, our code and our roadmap are open, our priorities are open. Transparency leads to a higher quality product.
...
Last, but definitely not least, we want to make sure that our work environment is pleasant for everyone involved. Your health and the health of your family and friends is more important than bookish-octo-waddle. Our community [is welcoming](CODE_OF_CONDUCT.md). We don't know everything; all of us can make mistakes.
...
When we think about whether we claim to "support" something, e.g. whether bookish-octo-waddle supports Windows 7, we use the following frame of reference. We document [which platforms we consider to fall into each category](Supported_Platforms.md).
...
* Supporting for bookish-octo-waddle development (we support a platform for bookish-octo-waddle development if one can contribute to bookish-octo-waddle itself from that platform).
