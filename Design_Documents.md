...
We recommend you use that template so that people can immediately recognize that this is a bookish-octo-waddle design document and that it is shared publicly.
...
The bookish-octo-waddle project uses design docs as a tool for guiding discussions.
