...
We commit to publishing security updates for the version of bookish-octo-waddle currently
...
This section describes the process used by the bookish-octo-waddle team when handling vulnerability reports.
...
5. Create a new [security advisory](https://github.com/lurkydismal/bookish-octo-waddle/security/advisories/new) if an advisory is required.
...
bookish-octo-waddle does not have a bug bounty program.
