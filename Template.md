...
1. File an issue using the [design doc issue template](https://github.com/lurkydismal/bookish-octo-waddle/issues/new?labels=design+doc&template=8_design_doc.yml) and assign it to yourself.
...
_Suggestion_: If you’re proposing a user-facing change to bookish-octo-waddle, describe the problem this proposal addresses from the user’s point of view, including:
...
Consider who you are writing for. Be explicit about who your audience is. Anyone contributing to bookish-octo-waddle? Just people who are regular contributors to a particular source file? Only you and your TL? The background section should be sufficient for people in your audience to understand your proposal.
