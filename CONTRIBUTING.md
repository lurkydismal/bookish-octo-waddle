Contributing to bookish-octo-waddle
=======================
...
We invite you to join the bookish-octo-waddle team, which is made up of volunteers!
...
doing outreach about bookish-octo-waddle, or helping out in any other way.

We grant commit access (which includes full rights to the issue
database, such as being able to edit labels) to people who have gained
our trust and demonstrated a commitment to bookish-octo-waddle.
...
1. Read [our code of conduct](CODE_OF_CONDUCT.md), which stipulates explicitly
    ...
    with triage, you are representing the bookish-octo-waddle team, and so you want to make sure to
...
Developing for bookish-octo-waddle
----------------------

If you would prefer to write code, you may wish to start with our list of [good first contributions](https://github.com/lurkydismal/bookish-octo-waddle/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+contribution%22).

To develop for bookish-octo-waddle, you will eventually need to become familiar
...
2. [bookish-octo-waddle design doc template](Template.md),
